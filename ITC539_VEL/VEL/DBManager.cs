...
namespace VEL
{
	public class DBManager
	{
		...
		public int InsertAll (List<VehicleInfo> vehListData)
		{
			int result = dbConn.InsertAll (vehListData);
			return result;
		...
		public int InsertAllTrips(List<TripInfo> tripListData)
		{
			int result = dbConn.InsertAll (tripListData);
			return result;
		}
		...
		{
			TripInfo trip = dbConn.Table<TripInfo> ().Where (a => a.Id.Equals (tripId)).FirstOrDefault ();
			return trip;
		}
